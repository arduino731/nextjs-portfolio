...
const Home = () => {
    return (
        ...
        <div className="colorBackground h-screen flex flex-col justify-center items-center text-center px-6">
            <h1 className="text-4xl md:text-6xl colorText font-bold mb-4">Hello, I am&nbsp;<span className="uppercase bg-slate-400 border rounded border-slate-900 dark:text-slate-900">Brian van Vlymen</span></h1>
